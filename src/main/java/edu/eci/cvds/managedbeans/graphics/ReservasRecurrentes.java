...
@SessionScoped
public class ReservasRecurrentes extends BasePageBean {
    ...
    private BarChartModel initBarModel() {
        ...
        graph.setLabel("Cantidad de reservas recurrentes");
        List<Reserva> reservas;
        try {
            reservas = serviciosBiblioteca.consultarReservasRecurrentes();
